...
- - isim
  ...
  - sıfat
ornekler:
- - Bir okuyucu için rahat okuma hissi veren yazı türleri bir başka okuyucu için sıkıcı olabilir.
- - Türkiye’de bazı bitki türleri çok eski tarihlerden beri hastalıklara karşı ilaç olarak kullanılmaktadır.
- - Parça bütünün, cins türün yerine geçti mi daralma olur. Hayvan canlı varlık karşısında türdür, aslan karşısında cinstir.
- - ''
- - Böyle bir araştırmayı bana öyle geliyor ki işte bu tip, bu tür politikacılar ve bu tür politikanın uydusu olmaktan bir şeyler umanlar istememektedir.
orneklerkaynak:
- - Muhsin Kadıoğlu
- - Turhan Baytop
- - ''
