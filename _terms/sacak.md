...
ornekler:
- - Perdenin saçağı.
- - Kurumuş dudakları mütemadiyen kımıldanıyor, mütemadiyen siyah kirpiklerinin ipekten birer saçak gibi tamamladığı çürümüş göz kapakları titriyordu.
- - ''
- - Han bekçisi, saçağın altındaki döşeğinde hâlâ uyumaktaydı.
- - ''
orneklerkaynak:
- - ''
- - Halide Edip Adıvar
