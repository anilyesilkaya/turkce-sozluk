...
- Çok yaramaz (çocuk); kudurgan
- Cinsel istekleri aşırı olan
- Kabarmış, taşmış (deniz, ırmak vb.)
- Gözü hiçbir şeyden yılmayan; azılı
ozellikler:
- - sıfat
- - sıfat
  - ''
...
- - sıfat
  ...
  - ''
ornekler:
- - Bakışları insanlıktan çıkmış, sanki karşımda ürkmüş, azgın bir hayvan var.
- - ''
- - ''
