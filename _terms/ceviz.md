...
- - isim
  ...
  - ''
ornekler:
- - Dikiliyor ansızın karşıma / Boynum kalınlığındaki ceviz.
- - Yedekleri ise ceviz dolabın alt tarafına kaldırılmıştı.
- - Cebimdeki paranın yarısını ayırıp avuç avuç ceviz alıyorum, sevinçle dolduruyorum ceplerimi.
orneklerkaynak:
- - Orhan Veli Kanık
- - Necati Cumalı
- - Reha Mağden
