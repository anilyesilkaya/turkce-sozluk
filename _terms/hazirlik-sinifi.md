...
- - isim
  - eğitim
ornekler:
- - Orta kısmı üç ve lise kısmı dört sınıftır, orta kısmının ayrıca hazırlık sınıfı vardır.Orta kısmı üç ve lise kısmı dört sınıftır, orta kısmının ayrıca hazırlık sınıfı vardır.
orneklerkaynak:
- - Süleyman Büyükkarcı
---
