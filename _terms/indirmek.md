...
- Kırmak, tahrip etmek
- Çeşitli alanlarda farklı amaçlarla kullanılması için hazırlanmış oyun, program, uygulama vb.ni genel ağ üzerinden bilgisayar, telefon ve tablet gibi araçlara kaydetmek
ozellikler:
- - -i
- - -i
  - ''
...
- - -i
  ...
  - ''
ornekler:
- - Zeynep'i o sel yatağından, yağdan kıl çeker gibi indirdi.
- - ''
- - ''
